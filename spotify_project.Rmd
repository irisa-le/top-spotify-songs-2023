...
ggplot(top_artists_numsongs, aes(x = reorder(artist_name, n), y = n)) +
...
# Create the bar plot
ggplot(top_artists_streams, aes(x = reorder(artist_name, total_streams), y = total_streams, fill = artist_name)) +
  geom_bar(stat = "identity") +
...
#### Scatterplot
```{r}
ggplot(songs_clean, aes(x=instrumentalness_pct, y=streams)) +
  geom_point()
```
