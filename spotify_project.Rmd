...
```{r}
mlr_model <- lm(streams ~ (bpm * key * mode * danceability_pct * valence_pct * energy_pct * acousticness_pct * instrumentalness_pct * liveness_pct * speechiness_pct)), data=songs_clean)
```
